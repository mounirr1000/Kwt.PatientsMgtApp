<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Payroll.aspx.cs" Inherits="Kwt.PatientsMgtApp.WebUI.Reports.Payroll" %>
            ...
            <div id="panelbar" class="panel">
                <div class="panel-success">
                    <h4 class="panel-title">
                        <a data-toggle="collapse" href="#collapse1" style="display: block;"><i class="fa fa-search"></i>&nbsp; <span class="p-2" style="text-decoration: underline">Filter Payroll Report
                ...
                <div id="collapse1" class="panel-collapse collapse">
                    <div class="panel-body">                                              
                        <ul class="fieldlistReport" style="margin: 0">
                            <li class="editor-field" style="padding-right: 5px;">
                                ...
                                <asp:DropDownList ID="ReportTypes" runat="server" Style="margin-bottom: 21px;" CssClass="k-dropdown" OnSelectedIndexChanged="reportTypes_SelectedIndexChanged">
                                    <asp:ListItem Text="---Please Select Report Type---" Value=""></asp:ListItem>
                                    <asp:ListItem Text="Outstanding Checks & Wires" Value="1"></asp:ListItem>
                            ...
                            <li class="editor-field">
                                ...
                                <label class="" for="StartDate">Payroll Start Date</label>

                                <asp:TextBox ID="StartDate" runat="server"></asp:TextBox>
                            </li>
                            <li class="editor-field">

                                <label class="" for="EndDate">Payroll End Date</label>

                                <asp:TextBox ID="EndDate" runat="server"></asp:TextBox>
                            </li>                           
                            
                            <li class="editor-field" style="padding-right: 5px;">
                                <asp:DropDownList ID="Payees" runat="server" Style="margin-bottom: 21px;" CssClass="k-dropdown">
                                </asp:DropDownList>
                            </li>
                            <li class="editor-field"style="padding-right: 5px;">
                                <asp:DropDownList ID="Employees" runat="server" Style="margin-bottom: 21px;" CssClass="k-dropdown">
                                </asp:DropDownList>
                            </li>
                            <li class="editor-field"style="padding-right: 5px;">
                                <asp:DropDownList ID="PaymentTypes" runat="server" Style="margin-bottom: 21px;" CssClass="k-dropdown">
                                </asp:DropDownList>
                            </li>
                            <li class="editor-field"style="padding-right: 5px;">
                                <asp:DropDownList ID="PayrollStatus" runat="server" Style="margin-bottom: 21px;" CssClass="k-dropdown">
                                </asp:DropDownList>
                            </li>
                            <%--  --%>
                            <li class="editor-field">                               
